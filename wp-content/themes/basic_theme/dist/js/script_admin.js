  ...
  if (document.getElementById("event_managment")) {
    ...
    for (var i = 0; i < handler_links.length; i++) {
      handler_links[i].addEventListener("click", function (event) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(window.api_settings.ajax_url, HandleData, {
          headers: {
            "Content-Type": "multipart/form-data"
          }
        }).then(function (response) {
          console.log("Admin:");
          console.log(response.data); //document.location.reload();
        });
      });
    }
...
/***/ 3:
/*!**************************************!*\
  !*** multi ./src/js/script_admin.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\OSPanel\domains\acc-site\wp-content\themes\acc_theme\src\js\script_admin.js */"./src/js/script_admin.js");
