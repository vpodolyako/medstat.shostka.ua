...
function theme_styles_and_scripts()
{
    ...
    wp_register_style('calendar_theme', get_template_directory_uri() . '/plugins/calendar/javascript-calendar.css');
    ...
    wp_register_script('calendar-script', get_template_directory_uri() . '/plugins/calendar/javascript-calendar.js'); 
